...
export {DeveloperAppInstallerComponent} from './developer/app-installer/dev-app-installer.component';
...
export {ConsumerAppsComponent} from './consumer/apps/consumer-apps.component';
